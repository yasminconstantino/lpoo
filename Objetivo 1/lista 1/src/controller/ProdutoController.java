...
public class ProdutoController {
    ...
    public static void main(String[] args) {
        ...
        //--------------------------------------
        //Estudos a parte, na video aula
        // ordena a coleção em ordem alfabetica, pelo nome do produto
        produtoList.sort(Comparator.comparing(Produto::getNome));
        System.out.println("\n-----------Lista Ordenada Alfabetica-----------\n");
        System.out.println(produtoList);

        // ordenando na ordem contraria a alfabetica
        produtoList.sort(Comparator.comparing(Produto::getNome).reversed());
        System.out.println("\n-----------Lista Ordenada NÂO Alfabetica-----------\n");
        System.out.println(produtoList);

        //outro modo de pesquisa por força bruta
        System.out.println("-----------Outra pesquisa força bruta-----------");
        produtoList.forEach(p -> {
            if(p.getNome().equals("Café")) {
